<x-app-layout title="Halaman Registrasi">
    <x-slot name="heading">Halaman Registrasi</x-slot>
    <!-- component -->
        ...
        <div class="relative mt-12 w-full max-w-lg sm:mt-10">
            ...
            <div
                ...
                <div class="flex flex-col p-6">
                    <h3 class="text-xl font-semibold leading-6 tracking-tighter">Registrasi</h3>
                    <p class="mt-1.5 text-sm font-medium text-white/50">Silakan daftarkan diri Anda untuk membuat akun baru.
                    </p>
                </div>
                <div class="p-6 pt-0">
                            ...
                            <div>
                                <div
                                    ...
                                    <input type="text" id="name" name="name"
                                           class="block w-full border-0 bg-transparent p-0 text-sm file:my-1 file:rounded-full file:border-0 file:bg-accent file:px-4 file:py-2 file:font-medium sm:leading-7 text-foreground">
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
